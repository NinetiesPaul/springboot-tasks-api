...
public class TaskValidationsOnCommentCreationTest {
    ...
    public void missingFields() throws Exception {
        ...
        assertThat(messages.contains("MISSING_TEXT")).isEqualTo(true);
    }
    ...
    public void invalidFields() throws Exception {
        ...
        ArrayList messages = (ArrayList) response.getBody().get("message");
        assertThat(messages.contains("TEXT_NOT_STRING")).isEqualTo(true);
    }
    ...
    public void emptyFields() throws Exception {
        ...
        ArrayList messages = (ArrayList) response.getBody().get("message");
        assertThat(messages.contains("EMPTY_TEXT")).isEqualTo(true);
    }

    @Test
    public void taskNotFound() throws Exception {
        String url = "http://localhost:8080/api/task/comment/999";

        Map<String, Object> payload = new HashMap<>();
        payload.put("text", "A task comment");
    ...
    public void commentNotFound() throws Exception {
        ...
        ArrayList messages = (ArrayList) response.getBody().get("message");
        assertThat(messages.contains("COMMENT_NOT_FOUND")).isEqualTo(true);
    }
}
