...
public class Task {
    ...
    public Task(Integer id, String title, String description, TaskTypeEnum type, TaskStatusEnum status, Users createdBy, Date createdOn, Users closedBy, Date closedOn)
	{
	}
